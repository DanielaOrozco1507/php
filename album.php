...
if (isset($_FILES['archivo']) && $_FILES['archivo']['size'] > 0) {
    ...
    $tipoarchivo = GetImageSize( $nombretemp );
        ...
        if ( $tamanyomax) { // Archivo demasiado grande? if (move_uploaded_file($nombretemp, $ruta.$nombrearchivo)) {
...
$filehandle = opendir($ruta); // Abrir archivos while ($file=readdir($filehandle)) {
if ($file != "." && $file != "..") {
